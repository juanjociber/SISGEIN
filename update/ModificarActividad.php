<?php 
    ...
    try {
        ...
        if(empty($_POST['id']) || empty($_POST['actividad'])){throw new Exception("La información esta incompleta.");}
        ...
        if(FnRegistrarActividad($conmy, $actividad)){
            $msg="Se modificó la Actividad.";
            $res=true;
        }else{
            $msg="Error modificando la Actividad.";
        }
